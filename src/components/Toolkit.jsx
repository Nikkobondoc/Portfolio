  ...
  return (
    <div className='tool-kit-whole'>
      ...
      <div ref={portfolioRef} className="portfolio-list">
        ...
        <div className="portfolio-item development"><Icon className='icon-tool' icon="devicon:html5-wordmark" width="24" height="24" />HTML5</div>
        <div className="portfolio-item development"><Icon className='icon-tool' icon="logos:css-3" width="24" height="24" />CSS 3</div>
        <div className="portfolio-item development"><Icon className='icon-tool' icon="logos:react" width="24" height="24" />React</div>
        ...
        <div className="portfolio-item development"><Icon className='icon-tool' icon="openmoji:javascript" width="24" height="24" />Javascript</div>
        ...
        <div className="portfolio-item development"><Icon className='icon-tool' icon="devicon:woocommerce" width="24" height="24" />Woocommerce</div>
        <div className="portfolio-item development"><Icon className='icon-tool' icon="mdi:wordpress" width="24" height="24" />Wordpress</div>
        <div className="portfolio-item design"><Icon className='icon-tool' icon="devicon:xd" width="24" height="24" />xd</div>
        <div className="portfolio-item design"><Icon className='icon-tool' icon="devicon:figma" width="24" height="24" />Figma</div>
